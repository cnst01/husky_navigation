...
def generate_launch_description():
    ...
    pkg_husky_navigation = get_package_share_directory('husky_navigation')

    # --- Nó de conversão GPS para Pose ---
    gps_to_pose_node = Node(
        package='husky_navigation',
        executable='gps_to_pose_slam.py',
        name='gps_to_pose_slam',
        output='screen',
        parameters=[{
    ...
    # Adicionar o nó GPS primeiro
    ld.add_action(gps_to_pose_node)
